				  ...
				  <div class="row author-info-row">
						<div class="col-md-8 col-12 col-sm-12">
							<ul class="list-inline flex-centered author-info-list">
								<li class="list-inline-item author-blk flex-centered">
									<a href="<?php if(get_field('author_linkedin_link')):?> <?php echo get_field('author_linkedin_link') ?> <?php else: ?> javascript:void(0) <?php endif;?>" <?php if(get_field('author_linkedin_link')):?> target="_blank" <?php endif; ?> >
											<?php if(get_field('author_image')): ?>
												<img src="<?php echo get_field('author_image')['url']?>" alt="image" data-toggle="tooltip" data-placement="bottom" title="<?php echo get_field('author_name'); ?>"/>
											<?php else: ?>
												<img src="<?php echo get_template_directory_uri(); ?>/img/default_profile_picture.png"  alt="Profile Pic" data-toggle="tooltip" data-placement="bottom" title="<?php echo get_field('author_name'); ?>"/>
											<?php endif; ?>
									...
									<li class="list-inline-item author-blk flex-centered">
										<a href="<?php if(get_field('author_linkedin_link_2')):?> <?php echo get_field('author_linkedin_link_2') ?> <?php else: ?> javascript:void(0) <?php endif;?>" <?php if(get_field('author_linkedin_link_2')):?> target="_blank" <?php endif; ?>>
											<?php if(get_field('author_image_2')): ?>
												<img src="<?php echo get_field('author_image_2')['url']?>" alt="image"  data-toggle="tooltip" data-placement="bottom" title="<?php echo get_field('author_name_2'); ?>"/>
											<?php else: ?>
												<img src="<?php echo get_template_directory_uri(); ?>/img/default_profile_picture.png"  alt="Profile Pic"  data-toggle="tooltip" data-placement="bottom" title="<?php echo get_field('author_name_2'); ?>"/>
											<?php endif; ?>
									...
									<li class="list-inline-item author-blk flex-centered">
										<a href="<?php if(get_field('author_linkedin_link_3')):?> <?php echo get_field('author_linkedin_link_3') ?> <?php else: ?> javascript:void(0) <?php endif;?>" <?php if(get_field('author_linkedin_link_3')):?> target="_blank" <?php endif; ?>>
											<?php if(get_field('author_image_3')): ?>
												<img src="<?php echo get_field('author_image_3')['url']?>" alt="image"  data-toggle="tooltip" data-placement="bottom" title="<?php echo get_field('author_name_3'); ?>"/>
											<?php else: ?>
												<img src="<?php echo get_template_directory_uri(); ?>/img/default_profile_picture.png"  alt="Profile Pic"  data-toggle="tooltip" data-placement="bottom" title="<?php echo get_field('author_name_3'); ?>"/>
											<?php endif; ?>
											<h4 class="support-text">
									...
									<li class="list-inline-item author-blk flex-centered">
										<a href="<?php if(get_field('author_linkedin_link_4')):?> <?php echo get_field('author_linkedin_link_4') ?> <?php else: ?> javascript:void(0) <?php endif;?>" <?php if(get_field('author_linkedin_link_4')):?> target="_blank" <?php endif; ?>>
											<?php if(get_field('author_image_4')): ?>
												<img src="<?php echo get_field('author_image_4')['url']?>" alt="image"  data-toggle="tooltip" data-placement="bottom" title="<?php echo get_field('author_name_4'); ?>"/>
											<?php else: ?>
												<img src="<?php echo get_template_directory_uri(); ?>/img/default_profile_picture.png"  alt="Profile Pic"  data-toggle="tooltip" data-placement="bottom" title="<?php echo get_field('author_name_4'); ?>"/>
											<?php endif; ?>
											<h4 class="support-text">
												<?php echo get_field('author_name_2') ?>
											</h4>
		...
		<div class="row blog-detail-row">
			<div class="col-md-10 offset-md-1 offset-lg-2 col-lg-8 col-sm-12 col-12">
				<div class="img-blk blog-detail-img-blk">
					...
					<?php else: ?>
							<img src="<?php echo get_template_directory_uri()?>/img/blog_placeholder.png" alt="Blog Placeholder">
					<?php endif; ?>
				</div>
