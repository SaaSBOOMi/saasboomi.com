      ...
      <div class="row flex-centered">
        <div class="col-sm-6 col-md-6 col-lg-6 col-12 left-blk">
          ...
          <div class="registration-content">
            ...
            <p class="heading4">Registrations open for SaaSBOOMi Enterprise  <?php echo date('Y',strtotime(get_field('event_dates')['from_date'])) ?></p>
            ...
            <?php else: ?>
            <h2 class="heading2 date">Thank you for attending enterprise <?php echo date('Y',strtotime(get_field('event_dates')['to_date']))?>!</h2>
            <?php endif?>
    ...
    <div class="container container-wrapper">
      <div class="cta-wrapper">
        <div class="row flex-centered">
          <div class="col-sm-6 col-md-6 col-lg-6 col-12 left-blk">
            <div class="registration-content">
              <h3 class="heading4">Registrations open for SaaSBOOMi Enterprise <?php echo date('Y',strtotime(get_field('event_dates')['from_date'])) ?></h3>
