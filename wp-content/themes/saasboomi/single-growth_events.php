...
<div class="event-annual-page event-growth-page">
      ...
      <div class="row flex-centered">
        <div class="col-sm-6 col-md-6 col-lg-6 col-12 left-blk">
          ...
          <div class="registration-content">
            ...
            <p class="heading4">Registrations open for SaaSBOOMi Growth   <?php echo date('Y',strtotime(get_field('event_dates')['from_date'])) ?></p>
            ...
            <?php else: ?>
            <h2 class="heading2 date">Thank you for attending growth  <?php echo date('Y',strtotime(get_field('event_dates')['to_date']))?>!</h2>
            <?php endif?>
    ...
    <div class="container container-wrapper">
      <div class="cta-wrapper">
        <div class="row flex-centered">
          <div class="col-sm-6 col-md-6 col-lg-6 col-12 left-blk">
            <div class="registration-content">
              <h3 class="heading4">Registrations open for SaaSBOOMi Growth <?php echo date('Y',strtotime(get_field('event_dates')['from_date'])) ?></h3>
  ...
  <section class="saasboomi-team-section team-section">
    <div class="container container-wrapper">
      <div class="row title-row">
        <div class="col-12">
            <h2 class="heading1">The SaaSBOOMiteam</h2>
        </div>
      </div>
      <div class="row content-row">
        <div class="col-12">
