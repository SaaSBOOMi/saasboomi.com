<?php
/*
* Template Name: Event Product Form
*/ ?>
<?php get_header(); ?>
...
<div class="event-annual-page forms-page event-form">
    <section class="forms-banner-section event-form">
        <div class="container">
            <div class="row flex-centered">
                <div class="col-md-3">
                    <h1 class="heading3">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/product_logo_black.svg" class="logo" />
                    </h1>
                    <p class="paragraph">
    ...
    <section class="form-section">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <form action="https://saasboomi.com:8080/https://docs.google.com/forms/u/0/d/e/1xuU2l-QFcMyOLjf-BuBM8rlFWM9UG-uFaYC91TJXlI8/formResponse" class="registration-form" data-parsley-validate="">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="entry.1953107505" class="form-control" placeholder="Enter Full Name" data-parsley-group="block1" required data-parsley-required-message="Full name is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="paragraph">Designation</label>
                                            <input type="text" name="entry.2138199954" class="form-control" placeholder="Enter Designation" data-parsley-group="block1" required data-parsley-required-message="Designation is required" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="entry.2058317869" class="form-control" placeholder="Enter Work Email ID" data-parsley-group="block1" required data-parsley-required-message="Work Email ID is required" data-parsley-type-message="Enter valid Work Email ID" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="country-group">
                                                <input type="tel" placeholder="Enter phone number" data-name="country-code" data-parsley-errors-container="#mobileNumber" required data-parsley-required-message="Mobile Number is required" data-parsley-type-message="Enter valid Mobile Number" data-parsley-type="digits"/>
                                                <input name="entry.1579331608" class="coutry-dial-code" type="hidden" />
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="url" name="entry.648847391" class="form-control" placeholder="https://www.linkedin.com/in/jhondoe" data-parsley-group="block1" required data-parsley-required-message="LinkedIn Profile Link is required" data-parsley-type-message="Enter valid URL"/>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="entry.1884398878" class="form-control" placeholder="Enter Company Name" data-parsley-group="block2" required data-parsley-required-message="Company Name is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="paragraph">City</label>
                                            <input type="text" name="entry.334809282" class="form-control" placeholder="Enter City" data-parsley-group="block2" required data-parsley-required-message="City is required" />
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="url" name="entry.322968155" class="form-control" placeholder="Enter Company Website" data-parsley-group="block2" required data-parsley-required-message="Company Website is required" data-parsley-type-message="Enter valid URL"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-select">
                                                <select class="paragraph" name="entry.2043601605" id="current-arr" placeholder="Select Current ARR Range">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-select">
                                                <select class="paragraph" name="entry.719980842" id="startup-target" placeholder="Select Startup Target Segment">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="entry.1155461172" class="form-control" placeholder="Your answer" data-parsley-group="block3" required data-parsley-required-message="This detail is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="paragraph">Top 3 chanllenges related to your Product in the company?</label>
                                            <input type="text" name="entry.1427300460" class="form-control" placeholder="Your answer" data-parsley-group="block3" required data-parsley-required-message="This detail is required" />
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <p class="paragraph">You have successfully registered for Product</p>
        ...
        $('.registration-form').on('submit', function(e) {
            ...
            if ($('.registration-form').parsley().isValid()) {
                ...
                $.ajax({
                    ...
                    url: "https://saasboomi.com:8080/https://docs.google.com/forms/d/1xuU2l-QFcMyOLjf-BuBM8rlFWM9UG-uFaYC91TJXlI8/formResponse",
                    data: datastring,
                    type: "post",
                    dataType: "jsonp",
                    statusCode: {
