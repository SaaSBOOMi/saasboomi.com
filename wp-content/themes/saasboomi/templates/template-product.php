        ...
        <div class="row flex-centered">
          <div class="col-sm-6 col-md-6 col-lg-6 col-12 left-blk">
            ...
            <div class="registration-content">
              ...
              <?php else : ?>
                <h2 class="heading2 date">Thank you for attending product <?php echo date('Y', strtotime(get_field('event_dates', $current_post["ID"])['to_date'])) ?>!</h2>
              <?php endif ?>
                ...
                <?php if (!$is_past_event && !$current_event_completed && (strtotime($current_date) < strtotime($current_post_date))) : ?>
                  <li class="list-inline-item">
                    <a
                      ...
                      <?php endif; ?>"
                      class="primary-btn primary-btn-dark btn-small primary-btn-disabled"
      ...
      <section class="cta-section">
        <div class="container container-wrapper">
          <div class="cta-wrapper">
            <div class="row flex-centered">
              <div class="col-sm-6 col-md-6 col-lg-9 col-12 left-blk">
                <div class="registration-content">
                  ...
                  <?php endif; ?>
                  <h4 class="heading3 date hidden"><?php echo date('jS', strtotime(get_field('event_dates', $current_post["ID"])['from_date'])) ?> - <?php echo date('jS F Y', strtotime(get_field('event_dates', $current_post["ID"])['to_date'])) ?></h4>
                  <p class="support-text">
                    <?php echo get_field('events_duration', $current_post["ID"]) ?>
                  </p>
                </div>
              </div>
              <div class="col-sm-6 col-md-6 col-lg-3 col-12 right-blk">
                <p class="apply-btn">
                  <a
                    href="
                    <?php if (get_field('registration_form_link', $current_post["ID"])) : ?>
                      ...
                      <div class="row card-row">
                        <div class="col-sm-6 col-md-6 col-6 card-left-blk">
                          <div class="content-wrapper">
                            ...
                            <h3 class="heading2"><?php echo get_the_title(); ?></h3>
                            <img class="annual-img" src="<?php echo get_template_directory_uri(); ?>/img/product_logo_black.svg" alt="Annual" />
                          </div>
                        </div>
                        <div class="col-sm-6 col-md-6 col-6 card-right-blk">
                          <div class="img-blk">
              ...
              <div class="row flex-centered">
                <div class="col-sm-6 col-md-6 col-lg-6 col-12 left-blk">
                  <div class="registration-content">
                    ...
                    <h4 class="heading3 date"><?php echo date('jS', strtotime(get_field('event_dates', $current_post["ID"])['from_date'])) ?> - <?php echo date('jS F Y', strtotime(get_field('event_dates', $current_post["ID"])['to_date'])) ?></h4>
                    <?php endif; ?>
                    <h4 class="heading3 date hidden"><?php echo date('jS', strtotime(get_field('event_dates', $upcoming_event["ID"])['from_date'])) ?> - <?php echo date('jS F Y', strtotime(get_field('event_dates', $upcoming_event["ID"])['to_date'])) ?></h4>
                    <p class="support-text">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-12 right-blk">
                  <p class="apply-btn">
                    <a href="<?php echo get_home_url(); ?>/product/" class="primary-btn primary-btn-dark btn-small">
                      View Details
                    </a>
                  </p>
                </div>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    // $('.content-wrapper:first-child').find('.day-item-content .day-item-content-visible').hide();
    // $('.content-wrapper:first-child').find('.day-item-content .day-item-content-hidden').show();
