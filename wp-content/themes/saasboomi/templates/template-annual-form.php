...
<div class="event-annual-page forms-page annual-form">
        ...
        <div class="container">
            <div class="row flex-centered">
                <div class="col-md-3">
                    ...
                    <p class="paragraph">
                        Asia’s Largest SaaS Conference,
                ...
                <div class="col-md-9 text-right">
                    <?php if (isset($_GET['title']) && $_GET['title']) : ?>
                        ...
                        <?php if (isset($_GET['start_date']) && $_GET['start_date'] && isset($_GET['end_date']) && $_GET['end_date']) : ?>
                            <p class="dates annual-dates heading5"><?php echo $_GET['start_date'] ?> - <?php echo $_GET['end_date'] ?> <?php if (isset($_GET['duration'])) : ?> • <?php echo $_GET['duration'];
                                                                                                                                                                            endif ?> </p>
                        <?php endif; ?>
                    <?php endif; ?>
                </div>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="sidebar">
                        ...
                        <ul class="list-unstyled">
                            <li>
                                <a href="javascript:void(0)" class="active sidebar-link" data-block="block1" data-target="#founderDetails">
                                    Founder Details
                ...
                <div class="col-md-9">
                    <form action="https://saasboomi.com:8080/https://docs.google.com/forms/u/0/d/e/1FAIpQLSdhigqulhCZrJeMxko9Up-yq1dr1e-jsiVJjFkYlefxExsb2w/formResponse" class="registration-form" data-parsley-validate="">
                        <div class="form-field-group" id="founderDetails">
                            <h4 class="heading4 field-title">Founder Details</h4>
                            <div class="fields-group">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="paragraph">First Name</label>
                                            <input type="text" name="entry.1250730129" class="form-control" placeholder="Enter First Name" data-parsley-group="block1" required data-parsley-required-message="First Name is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="paragraph">Designation</label>
                                            <input type="text" name="entry.545350845" class="form-control" placeholder="Enter Designation" data-parsley-group="block1" required data-parsley-required-message="Designation is required" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="entry.1424522851" class="form-control" placeholder="Enter Work Email" data-parsley-group="block1" required data-parsley-required-message="Work Email ID is required" data-parsley-type-message="Enter valid Work Email ID" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="country-group">
                                                <input type="tel" placeholder="Enter phone number" data-name="country-code" data-parsley-errors-container="#mobileNumber" required data-parsley-required-message="Mobile Number is required" data-parsley-type-message="Enter valid Mobile Number" data-parsley-type="digits" data-parsley-group="block1" class="form-control" />
                                                <input name="entry.1685293415" class="coutry-dial-code" type="hidden" />
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="url" name="entry.1210126934" class="form-control" placeholder="Enter LinkedIn Profile Link" data-parsley-group="block1" required data-parsley-required-message="LinkedIn Profile Link is required" data-parsley-type-message="Enter valid URL"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="paragraph">Twitter Handle</label>
                                            <input type="url" name="entry.1802070655" class="form-control" placeholder="Enter Twitter Handle" data-parsley-group="block1" required data-parsley-required-message="Twitter Handle is required" data-parsley-type-message="Enter valid URL"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="entry.699524491" class="form-control" placeholder="Enter Company Name" data-parsley-group="block2" required data-parsley-required-message="Company Name is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="paragraph">City</label>
                                            <input type="text" name="entry.700635281" class="form-control" placeholder="Enter City" data-parsley-group="block2" required data-parsley-required-message="City is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="paragraph">Company Website</label>
                                            <input type="url" name="entry.1826763282" class="form-control" placeholder="Enter Company Website" data-parsley-group="block2" required data-parsley-required-message="Company Website is required" data-parsley-type-message="Enter valid URL"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="paragraph">Current Revenue Range</label>
                                            <div class="form-select">
                                                <select id="crr" class="form-control" name="entry.1818420966" placeholder="Enter Current Revenue Range" data-parsley-group="block2" required data-parsley-required-message="Current Revenue Range is required">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="paragraph">Startup Traget Segment</label>
                                            <div class="form-select">
                                                <select id="sts" class="form-control" name="entry.2031885038" placeholder="Enter Current Revenue Range" data-parsley-group="block2" required data-parsley-required-message="Current Revenue Range is required">
                        ...
                        <div class="form-field-group" id="additionalDetails">
                            ...
                            <div class="fields-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="paragraph">Why would you like to be a part of SaaSBOOMi?</label>
                                            <input type="text" name="entry.945809582" class="form-control" placeholder="Your Answer" data-parsley-group="block4" required data-parsley-required-message="This detail is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="paragraph">Key chanllenges your start-up company</label>
                                            <input type="text" name="entry.553549440" class="form-control" placeholder="Your Answer" data-parsley-group="block4" required data-parsley-required-message="This detail is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="paragraph">Would you like to refer other SaaS Founders to our SaaSBOOMi Community?</label>
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="form-check custom-checkbox custom-control">
                                                        <input name="entry.1610665710" checked value="Yes" class="form-check-input custom-control-input" type="radio" id="category1" data-parsley-required-message="Select at least one category" data-parsley-errors-container="#categoryError" data-parsley-multiple="mymultiplelink" required />
                                                ...
                                                <div class="col-md-2">
                                                    <div class="form-check custom-checkbox custom-control">
                                                        <input name="entry.1610665710" value="No" class="form-check-input custom-control-input" type="radio" id="category2" data-parsley-multiple="mymultiplelink" required />
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="paragraph">If Yes, then please provide the Referee’s Name</label>
                                            <input type="text" name="entry.1219227574" class="form-control" placeholder="Your Answer" data-parsley-group="block4" required data-parsley-required-message="This detail is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="paragraph">Their Work Email ID</label>
                                            <input type="email" name="entry.378768984" class="form-control" placeholder="Your Answer" data-parsley-group="block4" required data-parsley-required-message="This detail is required" data-parsley-type-message="Enter valid Work Email ID"/>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="paragraph">Their Start-up Name</label>
                                            <input type="text" name="entry.924877453" class="form-control" placeholder="Your Answer" data-parsley-group="block4" required data-parsley-required-message="This detail is required" />
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('.registration-form .form-control').on('keyup', function() {
            ...
            var block4Valid = $('.registration-form').parsley().isValid({
                group: 'block4',
                force: true
            });
            if (block1Valid) {
        ...
        $('.registration-form').on('submit', function(e) {
            ...
            if ($('.registration-form').parsley().isValid()) {
                ...
                $.ajax({
                    ...
                    url: "https://saasboomi.com:8080/https://docs.google.com/forms/d/1U7c3SaOgX6XrzxDRzG3mZSbsotNIJIrNmQwlO2n2MSo/formResponse",
                    data: datastring,
                    type: "post",
                    dataType: "jsonp",
                    statusCode: {
