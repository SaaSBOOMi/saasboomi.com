...
<div class="event-annual-page initiative-debt-fund-page">
  <section class="event-banner-section">
    <div class="container container-wrapper">
      <div class="row flex-centered">
        <div class="col-sm-6 col-md-6 col-lg-6 col-12 left-blk">
          <img src="<?php echo get_template_directory_uri(); ?>/img/debt_fund_logo_black.svg"  alt="GrowthX" />
          ...
          <div class="registration-content">
            <?php
              ...
              if($enable == true):
            ?>
            <p class="heading4">Registrations open for Debt Fund</p>
            <?php else: ?>
            <p class="heading4">Registrations will open soon for Debt Fund</p>
            <?php endif; ?>
            <h2 class="paragraph">A debt fund which will help you survive this trying period</h2>
            <?php
              $enable = get_field('enable_apply_form');
              if($enable == true):
            ?>
        ...
        <div class="col-sm-6 col-md-6 col-lg-6 col-12 right-blk">
          <div class="vedio-blk background-prop" data-toggle="modal" data-target="#vedioModal">
            <svg class="complete-vedio-bg" width="455" height="470" viewBox="0 0 330 341" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M40.3552 164.474L3.95611 216.954C-4.24666 228.78 0.841749 245.196 14.2813 250.264L23.9546 253.912L40.3552 164.474Z" fill="#E4FBF9"/>
              <path d="M150.297 301.555L251.127 339.577C263.97 344.42 278.049 336.421 280.523 322.877L281.49 317.582L150.297 301.555Z" fill="#E4FBF9"/>
              <path d="M320.148 105.957L325.946 74.2185C327.536 65.5161 323.863 57.3724 317.528 52.5708L320.148 105.957Z" fill="#E4FBF9"/>
            </svg>
            <div class="featured-img-blk">
              ...
              <?php else: ?>
              <img class="featured-vedio-img" src="<?php echo get_template_directory_uri(); ?>/img/debt_fund_featured_bg.png"  alt="Debt Fund"/>
              <?php endif; ?>
            </div>
          </div>
        </div>
          ...
          <div class="col-sm-9 col-md-9 col-lg-9 col-12 left-blk">
            <ul class="list-inline tab-list" id="tabsList">
              <li class="active scenario list-inline-item event-logo" id="platform0" style="padding-right:30px;display: none;">
                <img src="<?php echo get_template_directory_uri(); ?>/img/debt_fund_logo_black.svg"  alt="Image" style="margin-top:-4px; height:20px;"/>
              </li>
              ...
              <li class="scenario list-inline-item" id="platform3" data-class="how-to-works-section">
              ...
              <li class="scenario list-inline-item" id="platform5" data-class="partners-section">
                <a href="javascript:void(0)" class="paragraph">Financial Partners</a>
              </li>
            </ul>
          </div>
          ...
          <div class="col-sm-6 col-md-6 col-lg-6 col-12 right-blk">
            <div class="featured-img-blk">
              <svg class="pattern1" width="35" height="25" viewBox="0 0 35 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M0 25L-2.18557e-07 20L25 20L25 25L0 25ZM-8.30516e-07 6L-1.09278e-06 0L16 -6.99382e-07L16 6L-8.30516e-07 6ZM9 11L9 15L35 15L35 11L9 11ZM29 25L29 20L35 20L35 25L29 25ZM-6.11959e-07 11L-4.37107e-07 15L6 15L6 11L-6.11959e-07 11Z" fill="#AAF2ED"/>
              </svg>
  ...
  <section class="cta-section">
    <div class="container container-wrapper">
      <div class="cta-wrapper">
        <div class="row flex-centered">
          <div class="col-sm-7 col-md-7 col-lg-7 col-12 left-blk">
            <div class="registration-content">
              <?php
                $enable = get_field('enable_apply_form');
                if($enable == true):
              ?>
                <h3 class="heading4">Registrations open for Debt Fund</h3>
              <?php else: ?>
                <h3 class="heading4">Registrations will open soon for Debt Fund</h3>
              <?php endif; ?>
                <h4 class="paragraph"> A debt fund which will help you survive this trying period</h4>
            </div>
          </div>
          <div class="col-sm-5 col-md-5 col-lg-5 col-12 right-blk">
            <?php
              $enable = get_field('enable_apply_form');
              if($enable == true):
            ?>
  ...
  <?php
    $steps = CFS()->get('how_it_works');
    if($steps && count($steps)):
  ?>
  <section class="how-to-works-section">
    <div class="container container-wrapper">
      <div class="row title-row">
          <div class="col-12">
            <h4 class="heading2">How it Works?</h4>
          </div>
      </div>
      <div class="row content-row who-can-apply">
        <?php foreach($steps as $step): ?>
...
<?php endif; ?>
  ...
  <?php
    $financial_partners = CFS()->get('financial_partners');
    if($financial_partners && count($financial_partners)):
  ?>
    <section class="partners-section growthx-cohort-section">
      <div class="container container-wrapper">
        <div class="row title-row">
          <div class="col-12 ">
            <h2 class="heading1">Financial Partner</h2>
          </div>
        </div>
        <div class="row content-row flex-centered text-center">
          <div class="col-sm-12 col-md-8 col-lg-8 col-12 offset-md-2 offset-lg-2 left-blk">
            <div class="row partners-row flex-centered">
              <div class="col-sm-6 col-md-6 col-lg-6 col-12 left-blk">
                <?php if($financial_partners[0]['image']): ?>
                  <div class="img-blk">
                    <img class="img1" src="<?php echo $financial_partners[0]['image']?>" alt="image"/>
                  </div>
                <?php endif;?>
              </div>
              <div class="col-sm-6 col-md-6 col-lg-6 col-12 left-blk">
                <?php if($financial_partners[1]['image']): ?>
                  <div class="img-blk">
                    <img class="img1" src="<?php echo $financial_partners[1]['image']?>" alt="image"/>
                  </div>
                <?php endif;?>
              </div>
              <div class="col-sm-6 col-md-6 col-lg-6 col-12 offset-md-3 offset-lg-3 offset-sm-3 middle-blk">
                <?php if($financial_partners[2]['image']): ?>
                  <div class="img-blk">
                    <img class="img1" src="<?php echo $financial_partners[2]['image']?>" alt="image"/>
                  </div>
                <?php endif;?>
              </div>
            </div>
  ...
  $(document).ready(function () {
    ...
    if($(window).outerWidth() > 0){
      ...
      $(window).scroll(function(){
          ...
          if($(window).scrollTop() > $('.how-to-apply-section').offset().top - topOffset && (!$('#tabsList li[data-class="how-to-apply-section"]').hasClass('active')) && $(window).scrollTop() < $('.how-to-works-section').offset().top - topOffset){
            setTimeout(function(){
              $('#tabsList li').removeClass('active');
          ...
          if($(window).scrollTop() > $('.how-to-works-section').offset().top - topOffset && (!$('#tabsList li[data-class="how-to-works-section"]').hasClass('active')) && $(window).scrollTop() < $('.team-section').offset().top - topOffset){
            setTimeout(function(){
              $('#tabsList li').removeClass('active');
              $('#tabsList li[data-class="how-to-works-section"]').addClass('active');
            },10);
          }
