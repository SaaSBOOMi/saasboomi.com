...
<div class="event-annual-page forms-page playbook-form">
    <section class="forms-banner-section">
        <div class="container">
            <div class="row flex-centered">
                <div class="col-md-3">
                    <h1 class="heading3">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/playbook_logo_black.svg" />
                    </h1>
                    <p class="paragraph">
                        Deep dive sessions with real <br />
                        insights of running a business
                    </p>
                </div>
                <div class="col-md-6 hidden">
                    <h4 class="heading4 title">Playbook - December</h4>
                    <h4 class="heading4 subtitle">“Gear up for 2021”</h4>
                    <p class="subititle description support-text">A session to reflect and refuel before the New Year with Krish Subramanian and Srikrishnan.</p>
                    <p class="dates heading5">19th December 2020 • 11 AM - 12.30 PM • Virtual Event</p>
                </div>
                <div class="col-md-9 image-grid">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/saas_tribe_form_hero.png" alt="Playbook form banner image" />
                </div>
            </div>
        </div>
    </section>
    <section class="form-section">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <form action="https://saasboomi.com:8080/https://docs.google.com/forms/u/0/d/e/1JVweMRr_T7iPKxpISHwO2om75FIzzxvZpz8hb0A7ikY/formResponse" class="registration-form" data-parsley-validate="">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="entry.1123612355" class="form-control" placeholder="Enter Full Name" data-parsley-group="block1" required data-parsley-required-message="Full name is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="paragraph">Designation</label>
                                            <input type="text" name="entry.1709711541" class="form-control" placeholder="Enter Designation" data-parsley-group="block1" required data-parsley-required-message="Designation is required" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="entry.2092384946" class="form-control" placeholder="Enter Work Email ID" data-parsley-group="block1" required data-parsley-required-message="Work Email ID is required" data-parsley-type-message="Enter valid Work Email ID" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="country-group">
                                                <input type="tel" placeholder="Enter phone number" data-name="country-code" data-parsley-errors-container="#mobileNumber" data-parsley-group="block1" data-parsley-type="digits" data-parsley-type-message="Enter valid Mobile Number"  required data-parsley-required-message="Mobile Number is required" />
                                                <input name="entry.1090872178" class="coutry-dial-code" type="hidden" />
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="url" name="entry.675486129" class="form-control" placeholder="Enter LinkedIn Profile Link" data-parsley-group="block1" required data-parsley-required-message="LinkedIn Profile Link is required" data-parsley-type-message="Enter valid URL"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="entry.232550399" class="form-control" placeholder="Enter Company Name" data-parsley-group="block2" required data-parsley-required-message="Company Name is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="paragraph">Your Startup’s Revenue Stage</label>
                                            <input type="text" name="entry.815161437" class="form-control" placeholder="Enter Your Startup’s Revenue Stage" data-parsley-group="block2" required data-parsley-required-message="Your Startup’s Revenue Stage is required" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-field-group" id="additionalDetails">
                            ...
                            <div class="fields-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="paragraph">Any questions for our speakers?</label>
                                            <input type="text" name="entry.376964382" class="form-control" placeholder="Your answer" data-parsley-group="block3" required data-parsley-required-message="This detail is required" />
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <p class="paragraph">You have successfully registered for Playbook</p>
        ...
        $('.registration-form').on('submit', function(e) {
            ...
            if ($('.registration-form').parsley().isValid()) {
                ...
                $.ajax({
                    ...
                    url: "https://saasboomi.com:8080/https://docs.google.com/forms/d/1JVweMRr_T7iPKxpISHwO2om75FIzzxvZpz8hb0A7ikY/formResponse",
                    data: datastring,
                    type: "post",
                    dataType: "jsonp",
                    statusCode: {
