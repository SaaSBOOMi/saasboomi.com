...
<div class="event-annual-page forms-page">
        ...
        <div class="container">
            <div class="row flex-centered">
                <div class="col-md-9">
                    ...
                    <p class="paragraph">
                        Are someone who truly believe in the ethos of #PayItForward?
                        Then, join the team of passionate volunteers dedicated to taking SaaSBOOMi higher and further.
                    </p>
                </div>
                <div class="col-md-3 image-grid">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/registration_form_hero.png" alt="Registration form banner image" />
                </div>
            </div>
        </div>
    </section>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="entry.642704711" class="form-control" placeholder="Enter Full Name" data-parsley-group="block1" required data-parsley-required-message="Full name is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="paragraph">Company Name</label>
                                            <input type="text" name="entry.1510614301" class="form-control" placeholder="Enter Company Name" data-parsley-group="block1" required data-parsley-required-message="Company name is required" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="entry.1510237245" class="form-control" placeholder="Enter Email ID" data-parsley-group="block1" required data-parsley-required-message="Email is required" data-parsley-type-message="Enter valid Email ID" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="country-group">
                                                ...
                                                <input name="entry.2128900306" class="coutry-dial-code" type="hidden" />
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="url" name="entry.551315513" class="form-control" placeholder="Enter LinkedIn Profile Link" data-parsley-group="block1" required data-parsley-required-message="LinkedIn Profile Link is required" data-parsley-type-message="Enter valid URL"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="paragraph">Twitter Profile Link</label>
                                            <input type="url" name="entry.886270896" class="form-control" placeholder="Enter Twitter Profile Link" data-parsley-group="block1" required data-parsley-required-message="Twitter Profile Link is required" data-parsley-type-message="Enter valid URL"/>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-field-group" id="companyDetails">
                            ...
                            <div class="fields-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="paragraph">Have you volunteered in the past? If yes, please provide details</label>
                                            <input type="text" name="entry.1942825513" class="form-control" placeholder="Your Answer" data-parsley-group="block2" required data-parsley-required-message="This detail is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="paragraph">Why do you want to be part of the volunteers for SaaSBOOMi? *</label>
                                            <input type="text" name="entry.1592210438" class="form-control" placeholder="Your Answer" data-parsley-group="block2" required data-parsley-required-message="This detail is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="paragraph">Is there any specific area that you are good at and would like to contribute? *</label>
                                            <input type="text" name="entry.1575931976" class="form-control" placeholder="Your Answer" data-parsley-group="block2" required data-parsley-required-message="This detail is required" />
                                        </div>
                                    </div>
                                </div>
                            </div>
