<?php
/*
* Template Name: Event Enterprise Form
*/ ?>
<?php get_header(); ?>
...
<div class="event-annual-page forms-page build-form">
    <section class="forms-banner-section build-form" style="background-color: #EBF7FE">
        <div class="container">
            <div class="row flex-centered">
                <div class="col-md-3">
                    <h1 class="heading3">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/enterprise_logo_black.svg" class="logo" />
                    </h1>
                    <p class="paragraph">
                        Exclusive Event for Enterprise <br/>
                        SaaS Startups
                    </p>
                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="entry.1877832390" class="form-control" placeholder="Enter Full Name" data-parsley-group="block1" required data-parsley-required-message="Full name is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="paragraph">Designation</label>
                                            <input type="text" name="entry.811254641" class="form-control" placeholder="Enter Designation" data-parsley-group="block1" required data-parsley-required-message="Designation is required" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="entry.1021927801" class="form-control" placeholder="Enter Work Email ID" data-parsley-group="block1" required data-parsley-required-message="Work Email ID is required" data-parsley-type-message="Enter valid Work Email ID" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="country-group">
                                                <input type="tel" placeholder="Enter phone number" data-name="country-code" data-parsley-errors-container="#mobileNumber" data-parsley-group="block1" data-parsley-type="digits" required data-parsley-required-message="Mobile Number is required" data-parsley-type-message="Enter valid Mobile Number"/>
                                                <input name="entry.1968064901" class="coutry-dial-code" type="hidden" />
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="url" name="entry.1281937594" class="form-control" placeholder="Enter LinkedIn Profile Link" data-parsley-group="block1" required data-parsley-required-message="LinkedIn Profile Link is required" data-parsley-type-message="Enter valid URL"/>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="entry.1272116477" class="form-control" placeholder="Enter Company Name" data-parsley-group="block2" required data-parsley-required-message="Company Name is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="paragraph">City</label>
                                            <input type="text" name="entry.1414339655" class="form-control" placeholder="Enter City" data-parsley-group="block2" required data-parsley-required-message="City is required" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="url" name="entry.620553289" class="form-control" placeholder="Enter Company Website" data-parsley-group="block2" required data-parsley-required-message="Company Website is required" data-parsley-type-message="Enter valid URL"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="paragraph">Company Founder’s Name</label>
                                            <input type="text" name="entry.7866614" class="form-control" placeholder="Enter Company Founder's Name" data-parsley-group="block2" required data-parsley-required-message="Company Founder's Name is required" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-select">
                                                <select class="paragraph" name="entry.1787304094" id="current-arr" placeholder="Select Current ARR Range">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-select">
                                                <select class="paragraph" name="entry.189223168" id="startup-target" placeholder="Select Startup Target Segment">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="entry.767799192" class="form-control" placeholder="Your answer" data-parsley-group="block3" required data-parsley-required-message="This detail is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="paragraph">Top 3 challenges related to your Product in the company?</label>
                                            <input type="text" name="entry.811678118" class="form-control" placeholder="Your answer" data-parsley-group="block3" required data-parsley-required-message="This detail is required" />
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <p class="paragraph">You have successfully registered for Enterprise</p>
        ...
        $('.registration-form').on('submit', function(e) {
            ...
            if ($('.registration-form').parsley().isValid()) {
                ...
                $.ajax({
                    ...
                    url: "https://saasboomi.com:8080/https://docs.google.com/forms/d/12TZNMPbG7D-GP5jB06RIsQwlmsMSQoS0Wnj7uVbfyak/formResponse",
                    data: datastring,
                    type: "post",
                    dataType: "jsonp",
                    statusCode: {
