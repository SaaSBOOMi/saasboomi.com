<?php
/*
* Template Name: Event Growth Form
*/ ?>
<?php get_header(); ?>
...
<div class="event-annual-page forms-page growth-form">
    <section class="forms-banner-section growth-form">
        <div class="container">
            <div class="row flex-centered">
                <div class="col-md-3">
                    <h1 class="heading3">
                        <img src="<?php echo get_template_directory_uri(); ?>/img/growth_logo_black.svg" class="logo" />
                    </h1>
                    <p class="paragraph">
                        Growth is a mindset, not an outcome
                    </p>
                </div>
    ...
    <section class="form-section">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <form action="https://saasboomi.com:8080/https://docs.google.com/forms/u/0/d/e/1FJTeiynbRiKxQGCPSnz-Atl5e9wqpdZ3Ov0NB5Voz3Q/formResponse" class="registration-form" data-parsley-validate="">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="entry.1769577471" class="form-control" placeholder="Enter Full Name" data-parsley-group="block1" required data-parsley-required-message="Full name is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="paragraph">Designation</label>
                                            <input type="text" name="entry.1777712483" class="form-control" placeholder="Enter Designation" data-parsley-group="block1" required data-parsley-required-message="Designation is required" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="entry.1068220082" class="form-control" placeholder="Enter Work Email ID" data-parsley-group="block1" required data-parsley-required-message="Work Email ID is required" data-parsley-type-message="Enter valid Work Email ID" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="country-group">
                                                ...
                                                <input name="entry.2095474475" class="coutry-dial-code" type="hidden" />
                                            </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="url" name="entry.2139889384" class="form-control" placeholder="Enter LinkedIn Profile Link" data-parsley-group="block1" required data-parsley-required-message="LinkedIn Profile Link is required" data-parsley-type-message="Enter valid URL"/>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="entry.1715441800" class="form-control" placeholder="Enter Company Name" data-parsley-group="block2" required data-parsley-required-message="Company Name is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="paragraph">City</label>
                                            <input type="text" name="entry.979280683" class="form-control" placeholder="Enter City" data-parsley-group="block2" required data-parsley-required-message="City is required" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="url" name="entry.1902814682" class="form-control" placeholder="Enter Company Website" data-parsley-group="block2" required data-parsley-required-message="Company Website is required" data-parsley-type-message="Enter valid URL"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="paragraph">Company Founder’s Name</label>
                                            <input type="text" name="entry.1260872" class="form-control" placeholder="Enter Founder’s Name" data-parsley-group="block2" required data-parsley-required-message="Company Founder’s Name is required" data-parsley-type-message="Company Founder’s Name is required"/>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="form-select">
                                                <select class="paragraph" name="entry.787599731" id="current-arr" placeholder="Select Current ARR Range">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="paragraph">What is your average Annual Contract Value</label>
                                            <div class="form-select">
                                                <select class="paragraph" name="entry.1360020713" id="startup-target" placeholder="Select Startup Target Segment">
                                                    <option value="Sub $ 5,000 PA" selected>Sub $ 5,000 PA</option>
                                                    <option value="$5,000 - $25,000 PA">$5,000 - $25,000 PA</option>
                                                    <option value="$25,000 - $100,000 PA">$25,000 - $100,000 PA</option>
                                                    <option value="$100,000 + PA">$100,000 + PA</option>
                                                </select>
                                            </div>
                        ...
                        <div class="form-field-group" id="additionalDetails">
                            ...
                            <div class="fields-group">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="paragraph">Do you have a marketing team? If yes, what is the size of your marketing team?</label>
                                            <input type="text" name="entry.1808167054" class="form-control" placeholder="Your answer" data-parsley-group="block3" required data-parsley-required-message="This detail is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="paragraph">Top 3 chanllenges related to your Growth in the company</label>
                                            <input type="text" name="entry.1426967778" class="form-control" placeholder="Your answer" data-parsley-group="block3" required data-parsley-required-message="This detail is required" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label class="paragraph">LinkedIn Profile Link of Two Collegues accompanying you at SaaSBOOMi Growth 2020 </label>
                                            <input type="text" name="entry.1086120928" class="form-control" placeholder="Your answer" data-parsley-group="block3" required data-parsley-required-message="This detail is required" />
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-body">
                ...
                <p class="paragraph">You have successfully registered for Growth</p>
        ...
        $('.registration-form').on('submit', function(e) {
            ...
            if ($('.registration-form').parsley().isValid()) {
                ...
                $.ajax({
                    ...
                    url: "https://saasboomi.com:8080/https://docs.google.com/forms/d/1FJTeiynbRiKxQGCPSnz-Atl5e9wqpdZ3Ov0NB5Voz3Q/formResponse",
                    data: datastring,
                    type: "post",
                    dataType: "jsonp",
                    statusCode: {
