<?php
/*
* Template Name: Partner with saasboomi Form
*/ ?>
<?php get_header(); ?>
            ...
            <div class="row">
              <div class="col-12">
                <div class="partner-form-wrapper">
                  <iframe class="airtable-embed" src="https://airtable.com/embed/shrPsxtlSWFjXkdR6?backgroundColor=green" frameborder="0" onmousewheel="" width="100%" height="533" style="background: transparent; border: 1px solid #ccc;"></iframe>
                </div>
              </div>
            </div>
        </div>
