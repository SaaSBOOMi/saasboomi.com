...
<div class="event-annual-page event-enterprise-page">
  <?php
  $current_post = null;
  $is_past_event = false;
  ...
  <?php if (count($current_post) > 0) : ?>
    ...
    ?>
    <section class="event-banner-section" <?php if ($current_event_completed) : ?> style="margin-bottom:50px" <?php endif; ?>>
      <div class="container container-wrapper">
        <div class="row flex-centered">
          <div class="col-sm-6 col-md-6 col-lg-6 col-12 left-blk">
            <img src="<?php echo get_template_directory_uri(); ?>/img/enterprise_logo_black.svg" alt="Enterprise" />
            <h1 class="heading2"><?php echo get_the_title($current_post["ID"]) ?></h1>
            <div class="registration-content">
              <?php if (!$is_past_event && !$current_event_completed) : ?>
                <p class="heading4">Registrations open for SaaSBOOMi Enterprise <?php echo date('Y', strtotime(get_field('event_dates', $current_post["ID"])['from_date'])) ?></p>
                  ...
                  <div class="row">
                    <div class="col-12 col-sm-12 col-md-12 col-lg-8">
                      <div class="form-group">
                        ...
                        <input name="entry.1603098731" type="email" name="email" class="form-control paragraph" id="email" placeholder="Enter Email Address" data-parsley-required>
                      </div>
                    </div>
          ...
          <div class="col-sm-6 col-md-6 col-lg-6 col-12 right-blk">
            ...
            <img class="vedio-bg-bottom" src="<?php echo get_template_directory_uri(); ?>/img/vedio_bottom_bg.svg"  alt="Annual" /> -->
              ...
              <?php if (get_field('video_video_link', $current_post["ID"])) : ?>
                <div class="play-vedio">
                  <svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M32.1691 42H9.8309C4.40144 42 0 37.5986 0 32.1691V9.8309C0 4.40144 4.40144 0 9.8309 0H32.1691C37.5986 0 42 4.40144 42 9.8309V32.1691C42 37.5986 37.5986 42 32.1691 42Z" fill="#43AFF9" />
              ...
              <svg class="complete-vedio-bg" width="455" height="470" viewBox="0 0 330 341" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <path d="M40.3552 164.474L3.95611 216.954C-4.24666 228.78 0.841749 245.196 14.2813 250.264L23.9546 253.912L40.3552 164.474Z" fill="#43AFF9" />
                <path d="M150.297 301.555L251.127 339.577C263.97 344.42 278.049 336.421 280.523 322.877L281.49 317.582L150.297 301.555Z" fill="#43AFF9" />
                <path d="M320.148 105.957L325.946 74.2185C327.536 65.5161 323.863 57.3724 317.528 52.5708L320.148 105.957Z" fill="#43AFF9" />
              </svg>
              ...
              <?php else : ?>
                <img class="featured-vedio-img" src="<?php echo get_template_directory_uri(); ?>/img/featured_vedio_img.png" alt="Enterprise" />
              <?php endif; ?>
            </div>
          </div>
        </div>
              ...
              <div class="col-sm-10 col-md-10 col-lg-10 col-12 left-blk">
                <ul class="list-inline tab-list" id="tabsList">
                  <li class="active scenario list-inline-item event-logo" id="platform0" style="padding-right:30px;display: none;">
                    <img src="<?php echo get_template_directory_uri(); ?>/img/enterprise_logo_black.svg" alt="Image" style="margin-top:-4px; height:28px;" />
                  </li>
              ...
              <div class="col-sm-6 col-md-6 col-lg-6 col-12 right-blk">
                <div class="featured-img-blk">
                  <svg class="pattern1" width="35" height="25" viewBox="0 0 35 25" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M0 25L-2.18557e-07 20L25 20L25 25L0 25ZM-8.30516e-07 6L-1.09278e-06 0L16 -6.99382e-07L16 6L-8.30516e-07 6ZM9 11L9 15L35 15L35 11L9 11ZM29 25L29 20L35 20L35 25L29 25ZM-6.11959e-07 11L-4.37107e-07 15L6 15L6 11L-6.11959e-07 11Z" fill="#43AFF9" />
                  </svg>
        ...
        <div class="container container-wrapper">
          <div class="cta-wrapper">
            <div class="row flex-centered">
              <div class="col-sm-6 col-md-6 col-lg-6 col-12 left-blk">
                <div class="registration-content">
                  <h3 class="heading4">Registrations open for SaaSBOOMiEnterprise <?php echo date('Y', strtotime(get_field('event_dates', $current_post["ID"])['from_date'])) ?></h3>
              ...
              <div class="col-sm-6 col-md-6 col-lg-6 col-12 right-blk">
                <!-- <form id="upcomingEventNotifyForm" class="stay-updated-form" data-parsley-validate="">
                  <div class="form-group">
                    ...
                    <input name="entry.256045868" type="text" name="fullname" maxlength="80" minlength="3" class="form-control paragraph" id="fname" placeholder="Enter Full Name" data-parsley-required>
                  </div>
                  <div class="form-group">
          ...
          <div class="container container-wrapper">
            <div class="cta-wrapper">
              <div class="row flex-centered">
                <div class="col-sm-6 col-md-6 col-lg-6 col-12 left-blk">
                  <div class="registration-content">
                    <h3 class="heading4">Registrations open for SaaSBOOMi Enterprise <?php echo date('Y', strtotime(get_field('event_dates', $current_post["ID"])['from_date'])) ?></h3>
                    <h4 class="heading3 date"><?php echo date('jS', strtotime(get_field('event_dates', $current_post["ID"])['from_date'])) ?> - <?php echo date('jS F Y', strtotime(get_field('event_dates', $current_post["ID"])['to_date'])) ?></h4>
                    <p class="support-text">
                      <?php echo get_field('events_duration', $current_post["ID"]) ?>
                    </p>
          ...
          <div class="container container-wrapper">
              ...
              <?php while ($the_query->have_posts()) : $the_query->the_post();
                ...
                ?>
                  <div class="<?php if (count($the_query->posts) > 1) : ?>col-sm-6 col-md-6 col-12 <?php else : ?> col-sm-12 col-md-12 col-12 <?php endif ?>">
                    <a href="<?php echo get_home_url() ?>/enterprise/?post_slug=<?php echo get_post_field('post_name', get_post()) ?>" class="card-wrapper">
                      <div class="row card-row">
                        <div class="col-sm-6 col-md-6 col-6 card-left-blk">
                          <div class="content-wrapper">
                            <img class="circle-bg" src="<?php echo get_template_directory_uri(); ?>/img/past_events_circle_bg.svg" alt="Enterprise" />
                            <h3 class="heading2">SaaSBOOMi <?php echo date('Y', strtotime(get_field('event_dates', get_the_ID())['from_date'])) ?></h3>
                            <img class="annual-img" src="<?php echo get_template_directory_uri(); ?>/img/enterprise_logo_black.svg" alt="Enterprise" />
                          </div>
                        </div>
                        <div class="col-sm-6 col-md-6 col-6 card-right-blk">
                          <div class="img-blk">
                            <?php if (get_the_post_thumbnail_url()) : ?>
                              <img class="featured-image" src="<?php echo get_the_post_thumbnail_url(); ?>" alt="Enterprise" />
                            <?php else : ?>
                              <img class="featured-image" src="<?php echo get_template_directory_uri(); ?>/img/dummy_events.png" alt="Enterprise" />
                            <?php endif ?>
                            <svg class="shape-bg" width="92" height="284" viewBox="0 0 92 284" fill="none" xmlns="http://www.w3.org/2000/svg">
                              <path d="M91.3906 0C84.332 0 78.1055 4.62695 76.0703 11.3867L0.207031 263.387C0.132812 263.637 0.0625 263.887 0 264.137V0H91.3906Z" fill="#EBF7FE" />
                              <path d="M15.5273 284C7.84375 284 1.71875 278.693 0 271.906V284H15.5273Z" fill="#EBF7FE" />
                            </svg>
                          </div>
                        </div>
                      </div>
                      ...
                      <div class="row card-row">
                        <div class="col-sm-6 col-md-6 col-6 card-left-blk">
                          <div class="content-wrapper">
                            ...
                            <h3 class="heading2">SaaSBOOMi <?php echo date('Y', strtotime(get_field('event_dates', get_the_ID())['from_date'])) ?></h3>
                            <img class="annual-img" src="<?php echo get_template_directory_uri(); ?>/img/enterprise_logo_black.svg" alt="Annual" />
                          </div>
                        </div>
                        <div class="col-sm-6 col-md-6 col-6 card-right-blk">
                          <div class="img-blk">
            ...
            <?php if ($post_count > 2) : ?>
              <div class="row view-all-row text-center">
                <div class="col-md-12">
                  <p class="show-more-btn">
                    <a href="<?php echo get_permalink(663); ?>" class="secondary-btn btn-large" id="viewMore">
                      View More
                    </a>
                  </p>
                </div>
          ...
          <div class="container container-wrapper">
            <div class="cta-wrapper">
              <div class="row flex-centered">
                <div class="col-sm-6 col-md-6 col-lg-6 col-12 left-blk">
                  <div class="registration-content">
                    <h3 class="heading4">Registrations open for SaaSBOOMi Enterprise <?php echo date('Y', strtotime(get_field('event_dates', $upcoming_event["ID"])['from_date'])) ?></h3>
                    <h4 class="heading3 date"><?php echo date('jS', strtotime(get_field('event_dates', $upcoming_event["ID"])['from_date'])) ?> - <?php echo date('jS F Y', strtotime(get_field('event_dates', $upcoming_event["ID"])['to_date'])) ?></h4>
                    <p class="support-text">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-12 right-blk">
                  <p class="apply-btn">
                    <a href="<?php echo get_home_url(); ?>/enterprise/" class="primary-btn primary-btn-dark btn-small">
                      View Details
                    </a>
                  </p>
                </div>
            ...
            <div class="cta-wrapper">
              <div class="row flex-centered">
                <div class="col-sm-12 col-md-12 col-lg-12 col-12 left-blk">
                  <div class="registration-content">
                    <h3 class="heading4">SaaSBOOMi Enterprise <?php echo date('Y', strtotime('+1 year')); ?></h3>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="vedio-blk">
          <?php echo get_field('video_video_link', $current_post["ID"]) ?>
        </div>
      </div>
    </div>
  </div>
    ...
    $('#upcomingEventNotifyForm').on('submit', function(e) {
      ...
      if ($('#upcomingEventNotifyForm').parsley().isValid()) {
        ...
        $.ajax({
          ...
          url: "https://saasboomi.com:8080/https://docs.google.com/forms/d/1tEpBg4d_-A1XWzh42vqsC6ZzVn1IZSaxLPqSiC2SwvQ/formResponse",
          data: datastring,
          type: "post",
          dataType: "jsonp",
          statusCode: {
