...
<div class="event-annual-page">
      ...
      <div class="row flex-centered">
        <div class="col-sm-6 col-md-6 col-lg-6 col-12 left-blk">
          ...
          <div class="registration-content">
            ...
            <p class="heading4">Registrations open for SaaSBOOMi Annual  <?php echo date('Y',strtotime(get_field('event_dates', $current_post["ID"])['from_date'])) ?></p>
        ...
        <div class="col-sm-12 col-md-5 col-lg-5 col-12 left-blk">
            <div class="row content-row">
                <div class="col-sm-6 col-md-6 col-lg-6 col-12 grid-blk">
                  ...
                  <?php if($gallery[0]['image']): ?>
                    <img class="img1" src="<?php echo $gallery[0]['image']?>"  alt="Image" />
                  <?php endif;?>
                  <?php if($gallery[1]['image']): ?>
                    <img class="img2" src="<?php echo $gallery[1]['image']?>"  alt="Image" />
                  <?php endif;?>
                </div>
                <div class="col-sm-6 col-md-6 col-lg-6 col-12 grid-blk">
                  <?php if($gallery[2]['image']): ?>
                    <img class="img3" src="<?php echo $gallery[2]['image']?>"  alt="Image" />
                  <?php endif;?>
                  <?php if($gallery[3]['image']): ?>
                    <img class="img4" src="<?php echo $gallery[3]['image']?>"  alt="Image" />
                  <?php endif;?>
        ...
        <div class="col-sm-12 col-md-7 col-lg-7 col-12 left-blk">
          <div class="row content-row">
            <div class="col-sm-7 col-md-7 col-lg-7 col-12 grid-blk">
              ...
              <?php if($gallery[4]['image']): ?>
                <img class="img5" src="<?php echo $gallery[4]['image']?>"  alt="Image" />
              <?php endif;?>
              <?php if($gallery[5]['image']): ?>
                <img class="img6" src="<?php echo $gallery[5]['image']?>"  alt="Image" />
              <?php endif;?>
              <?php if($gallery[6]['image']): ?>
                <img class="img7" src="<?php echo $gallery[6]['image']?>"  alt="Image" />
              <?php endif;?>
            </div>
            <div class="col-sm-5 col-md-5 col-lg-5 col-12 grid-blk">
              <?php if($gallery[7]['image']): ?>
                <img class="img8" src="<?php echo $gallery[7]['image']?>"  alt="Image" />
              <?php endif;?>
              <?php if($gallery[8]['image']): ?>
                <img class="img9" src="<?php echo $gallery[8]['image']?>"  alt="Image" />
              <?php endif;?>
              <p class="color-bar yellow-bar text-right bottom-bar">
                <span></span>
              </p>
    ...
    <div class="container container-wrapper">
      <div class="cta-wrapper">
        <div class="row flex-centered">
          <div class="col-sm-6 col-md-6 col-lg-6 col-12 left-blk">
            <div class="registration-content">
              <h3 class="heading4">Registrations open for SaaSBOOMi Annual <?php echo date('Y',strtotime(get_field('event_dates')['from_date'])) ?></h3>
  ...
  <section class="cta-section" <?php if($current_event_completed): ?> style="padding-bottom: 0" <?php endif;?>>
    <?php if(!$current_event_completed && (strtotime($current_date) < strtotime($current_post_date)) && (get_field('registration_opened', $current_post['ID']) == true)): ?>
    <div class="container container-wrapper">
      <div class="cta-wrapper">
        <div class="row flex-centered">
          <div class="col-sm-6 col-md-6 col-lg-6 col-12 left-blk">
  ...
  $('#upcomingEventNotifyForm').on('submit', function(e){
      ...
      if($('#upcomingEventNotifyForm').parsley().isValid()){
          ...
          $.ajax({
              ...
              url: "https://saasboomi.com:8080/https://docs.google.com/forms/d/1e7Y4UqHV5i3VD4FFbkR0ozKTaYKAJG2dIiFxg6dHPZ0/formResponse",
              data: datastring,
              type: "post",
              dataType: "jsonp",
              statusCode: {
